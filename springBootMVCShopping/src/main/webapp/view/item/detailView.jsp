...
<script>
	...
	$(function(){
		...
		$("#inquire").click(function(){
			//location.href = "inquireList.inq?=num=${dto.goodsNum}";
			option = {
					type:"post",
					url:"inquireList.inq",
					data:{"goodsNum":"${dto.goodsNum}"},
		...
		$("#wish").click(function(){
			$.ajax({
				...
				success:function(result){
					if(result == "0"){
						$("#wish").attr("src","images/하트1.jpg");
						alert("관심상품으로 등록되었습니다.");
					}else{
						$("#wish").attr("src","images/빈하트1.jpg");
	...
	<table width="800" align="center">
		...
		<tr>
			<td>
				...
				<c:if test="${isTrue == 0 }">
				<img src="images/빈하트1.jpg" id="wish" width="20" />
				</c:if>
				<c:if test="${isTrue == 1}">
				<img src="images/하트1.jpg" id="wish" width="20" />
				</c:if>
			</td>
		</tr>
		</table>
