...
function itemsDel(){
	...
	//locateion.href = "cartItemDel.item?goodsNums="+goodsNums;
	$.ajax({
		type="post".
...
총 수량 : <span id="totQtyt">${totQtyt } 개</span><br />
전체 금액 : <span id="totalPrice">${totPri } 원</span><br />
</td>
</tr>
