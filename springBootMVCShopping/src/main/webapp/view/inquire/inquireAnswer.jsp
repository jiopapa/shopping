...
<tr><th>고객 번호</th><td>${dto.memberNum }</td></tr>
<tr><th>문의 제목</th><td>${dto.inquireSubject }</td></tr>
<tr><th>담당 직원</th><td>${dto.empNum }</td></tr>
<tr><th>답변 내용</th><td><textarea rows="10" cols="50" name="inquireAnswer">${dto.inquireAnswer }
</textarea></td></tr>
<tr><th>답변 날짜</th><td>${dto.inquireAnswerDate }</td></tr>

<tr><th colspan="2"><input type="submit" value="답변 등록"></th></tr>
