...
public class GoodsIpgoController {
	...
	@ResponseBody
	public Map<String, Object> goodsItem(@RequestParam(value = "searchWord", required = false) String searchWord,
	...
	public String goodsIpgoDelete(@RequestParam("ipgoNum") String ipgoNum,
	...
	public String goodsIpgoUpdate(@RequestParam("ipgoNum") String ipgoNum,
			@RequestParam("num") String goodsNum, Model model) {
		GoodsIpgoDTO dto = goodsIpgoDetailService.execute(ipgoNum, goodsNum);
